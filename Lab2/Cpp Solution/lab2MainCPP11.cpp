...
int main() {
    ...
    std::pair<std::vector<int>, std::vector<int>> resultMatrix = dijkstra_AdjMatrix(adjMatrix, source);
    std::vector<int> distMatrix = resultMatrix.first;
    std::vector<int> piMatrix = resultMatrix.second;
    ...
    std::pair<std::vector<int>, std::vector<int>> resultHeap = dijkstra_MinHeap(adjList, source);
    std::vector<int> distHeap = resultHeap.first;
    std::vector<int> piHeap = resultHeap.second;
